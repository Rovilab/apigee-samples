...
delete_app_if_necessary "${app_name_root}-1" "$PROJECT_ID" "$dev_email"
delete_app_if_necessary "${app_name_root}-2" "$PROJECT_ID" "$dev_email"
delete_app_if_necessary "${app_name_root}-3" "$PROJECT_ID" "$dev_email"
